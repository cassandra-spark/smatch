  ...
  return (
    <div className="bg-slate-800 flex flex-col items-center justify-between min-h-screen p-5">
      ...
      <div className="w-full max-w-md">
        <form className="mt-8 flex flex-col items-center w-full px-5" onSubmit={(e) => login(e)}>
          ...
          <div className="flex justify-between w-full mt-5">
            <Link to="/signup" className="bg-gray-100 hover:bg-gray-300 text-gray-800 rounded-full px-8 py-2">Sign up</Link>
            <button className="bg-orange-600 hover:bg-orange-500 text-white rounded-full px-8 py-2" onClick={(e) => login(e)}>Submit</button>
          </div>
        </form>
      </div>
